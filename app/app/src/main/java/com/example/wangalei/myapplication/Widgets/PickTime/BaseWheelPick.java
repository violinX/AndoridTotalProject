        ...
        , OnWheelScrollListener
{
    ...
    public BaseWheelPick(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.WidgetsDatePicker);
        textColor = a.getColor(R.styleable.WidgetsDatePicker_picker_text_color, 0xffdddddd);
        selectColor = a.getColor(R.styleable.WidgetsDatePicker_picker_select_textColor, 0xff444444);
        split = a.getColor(R.styleable.WidgetsDatePicker_picker_split, 0xffdddddd);
        splitHeight = (int) a.getDimension(R.styleable.WidgetsDatePicker_picker_split_height, 0.5f);
