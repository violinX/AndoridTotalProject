package com.example.wangalei.myapplication.TakePhotoUtils;
...
/**
 * Created by wangalei on 2017/6/8.
 */
...
public class TakePhotoCustomHelper {
    ...
    public static TakePhotoCustomHelper of(View rootView){
        return new TakePhotoCustomHelper(rootView);
    }
    private TakePhotoCustomHelper(View rootView) {
