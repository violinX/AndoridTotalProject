...
import com.example.wangalei.myapplication.Adapter.UserAdapter;
import com.example.wangalei.myapplication.Bean.User;
import com.example.wangalei.myapplication.GreenDao.GreenDaoManager;
import com.example.wangalei.myapplication.MyApplication;
import com.example.wangalei.myapplication.R;
import com.example.wangalei.myapplication.gen.UserDao;

import java.util.ArrayList;
import java.util.List;

public class ShowDemoGreenDaoActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_demo_green_dao);
        initView();
        initData();
    }
