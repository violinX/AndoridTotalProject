...
public class ShowDemoTakePhotoResultActivity extends Activity {
    ArrayList<TImage> images;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_demo_take_photo_result);
    ...
    private void showImg() {
        ...
        for (int i = 0, j = images.size(); i < j - 1; i += 2) {
            View view = LayoutInflater.from(this).inflate(R.layout.takephoto_image_show, null);
